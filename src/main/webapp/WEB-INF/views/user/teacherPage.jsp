...
<nav class="navbar navbar-inverse">
	...
	<ul class="nav navbar-nav">
				<li class="active"><a href="#">Dear <strong>${user}</strong>, Welcome to teacher Page.</a></li>
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="#"> 강사정보  <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="#">강사정보 조회</a></li>
						<li><a href="#">강사정보 수정</a></li>
					</ul></li>
