...
<body>
	...
	<div class="container">
		...
		<form class="form-horizontal" action="${pageContext.request.contextPath}/anonymous/insertjoin" method="POST">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="password" class="form-control" id="pw"
						placeholder="password 입력" name="member_password">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="Phone_Number"
						placeholder="Phone Number 입력" name="member_phone">
				</div>
			</div>
